...
main(int argc, char *argv[])
{
  ...
  14:	80058593          	addi	a1,a1,-2048 # 810 <malloc+0x108>
  18:	4509                	li	a0,2
  ...
  52:	7da58593          	addi	a1,a1,2010 # 828 <malloc+0x120>
  56:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cc:	4d850513          	addi	a0,a0,1240 # 8a0 <digits>
 3d0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d2:	37a70713          	addi	a4,a4,890 # 848 <malloc+0x140>
 ...
 55e:	346b8b93          	addi	s7,s7,838 # 8a0 <digits>
 ...
 5b4:	29090913          	addi	s2,s2,656 # 840 <malloc+0x138>
        while(*s != 0){
...
free(void *ap)
{
 ...
 694:	d507b783          	ld	a5,-688(a5) # 13e0 <freep>
 ...
 6bc:	00e6ea63          	bltu	a3,a4,6d0 <free+0x4a>
{
 ...
 6fe:	cef73323          	sd	a5,-794(a4) # 13e0 <freep>
}
 702:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 728:	cbc53503          	ld	a0,-836(a0) # 13e0 <freep>
 ...
 758:	c8c90913          	addi	s2,s2,-884 # 13e0 <freep>
  if(p == (char*)-1)
 75c:	5afd                	li	s5,-1
 ...
 76c:	c8878793          	addi	a5,a5,-888 # 13f0 <base>
 770:	00001717          	auipc	a4,0x1
 774:	c6f73823          	sd	a5,-912(a4) # 13e0 <freep>
 778:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ea:	bea73d23          	sd	a0,-1030(a4) # 13e0 <freep>
      return (void*)(p + 1);
