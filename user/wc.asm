...
wc(int fd, char *name)
{
  ...
  3c:	908a0a13          	addi	s4,s4,-1784 # 940 <malloc+0x10a>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  aa:	8ba50513          	addi	a0,a0,-1862 # 960 <malloc+0x12a>
  ...
  d8:	87c50513          	addi	a0,a0,-1924 # 950 <malloc+0x11a>
...
main(int argc, char *argv[])
{
 ...
 15a:	7f258593          	addi	a1,a1,2034 # 948 <malloc+0x112>
 15e:	4501                	li	a0,0
 ...
 17a:	7fa50513          	addi	a0,a0,2042 # 970 <malloc+0x13a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4fa:	4f250513          	addi	a0,a0,1266 # 9e8 <digits>
 4fe:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 600:	39470713          	addi	a4,a4,916 # 990 <malloc+0x15a>
 ...
 68c:	360b8b93          	addi	s7,s7,864 # 9e8 <digits>
 ...
 6e2:	2aa90913          	addi	s2,s2,682 # 988 <malloc+0x152>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7c2:	c827b783          	ld	a5,-894(a5) # 1440 <freep>
 ...
 7ea:	00e6ea63          	bltu	a3,a4,7fe <free+0x4a>
{
 ...
 82c:	c0f73c23          	sd	a5,-1000(a4) # 1440 <freep>
}
 830:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 856:	bee53503          	ld	a0,-1042(a0) # 1440 <freep>
 ...
 886:	bbe90913          	addi	s2,s2,-1090 # 1440 <freep>
  if(p == (char*)-1)
 88a:	5afd                	li	s5,-1
 ...
 89a:	dba78793          	addi	a5,a5,-582 # 1650 <base>
 89e:	00001717          	auipc	a4,0x1
 8a2:	baf73123          	sd	a5,-1118(a4) # 1440 <freep>
 8a6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 918:	b2a73623          	sd	a0,-1236(a4) # 1440 <freep>
      return (void*)(p + 1);
