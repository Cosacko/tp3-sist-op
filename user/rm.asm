...
free(void *ap)
{
 ...
 6ac:	d387b783          	ld	a5,-712(a5) # 13e0 <freep>
 ...
 6d4:	00e6ea63          	bltu	a3,a4,6e8 <free+0x4a>
{
 ...
 716:	ccf73723          	sd	a5,-818(a4) # 13e0 <freep>
}
 71a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 740:	ca453503          	ld	a0,-860(a0) # 13e0 <freep>
 ...
 770:	c7490913          	addi	s2,s2,-908 # 13e0 <freep>
  if(p == (char*)-1)
 774:	5afd                	li	s5,-1
 ...
 784:	c7078793          	addi	a5,a5,-912 # 13f0 <base>
 788:	00001717          	auipc	a4,0x1
 78c:	c4f73c23          	sd	a5,-936(a4) # 13e0 <freep>
 790:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 802:	bea73123          	sd	a0,-1054(a4) # 13e0 <freep>
      return (void*)(p + 1);
